...
Rules:
 - Comment block characters preceding "#PYGEN_CODE" must be consistent for the whole block
   and all blocks in the file
 - Input file must have a newline at the end of the file otherwise you might miss some output
 - Every block needs a #PYGEN_OUTPUT to tell the generator where to put the output code
   
TODO:
 - Remove generator code from output file (add option to keep)
